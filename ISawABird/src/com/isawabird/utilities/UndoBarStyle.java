...
public class UndoBarStyle {
	...
	public UndoBarStyle(final int icon, final int title, final int bg, final long duration) {
	...
	public String toString() {
		return "UndoBarStyle{" + "iconRes=" + iconRes + ", titleRes=" + titleRes + ", bgRes=" + bgRes + ", duration=" + duration + '}';
	}
}
